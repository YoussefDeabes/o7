...
class CardUtils {
  static String? validateCVV(
    ...
    if (value == null || value.isEmpty) {
      // return 'Required';
      return translate(LangKeys.thisFieldIsRequired);
    }

    if (value.length < 3 || value.length > 4) {
      // return "Invalid cvv";
      return translate(LangKeys.invalidCvv);
    }
    return null;
  }
...
// A valid month is between 1 (January) and 12 (December)
      ...
      return translate(LangKeys.invalidMonth);
    }
...
// Note that, it's valid doesn't mean that it has not expired.
      // return 'Invalid year';
      return translate(LangKeys.invalidYear);
    }

    if (!hasDateExpired(month, year)) {
      // return "Expired card";
      return translate(LangKeys.expiredCard);
    }
    return null;
  }
...
// year
  ...
  static Widget? getCardIcon(CardType? cardType) {
    ...
    switch (cardType) {
      case CardType.Master:
        img = AssPath.mastercardLogo;
        break;
      case CardType.Visa:
        img = AssPath.visaLogo;
        break;
  ...
  static String? validateCardNum(
    ...
    if (input.length < 8) {
      ...
      return translate(LangKeys.invalidCard);
    }
