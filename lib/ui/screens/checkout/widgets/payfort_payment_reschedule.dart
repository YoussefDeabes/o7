...
class PayfortPaymentRescheduleWidget extends StatefulWidget {
  ...
  const PayfortPaymentRescheduleWidget(
  ...
  @override
  PayfortPaymentRescheduleWidgetState createState() => PayfortPaymentRescheduleWidgetState();
}

class PayfortPaymentRescheduleWidgetState extends State<PayfortPaymentRescheduleWidget> {
            ...
            children: [
              InAppWebView(
                ...
                onLoadStart: (controller, url) {
                  ...
                  } else if (url.toString().contains('faild') || url.toString().contains('failed')) {
  ...
  String postDataToWebView() {
    ...
    String signature = "$signaturePhrase"
        ...
        "${FortConstants.merchantExtraAttr}=${FortConstants.merchantExtraReschedule}"
...
action='${FortConstants.payfortTokenization}' method='POST'>
    ...
    <input name='${FortConstants.merchantExtraAttr}' value='${FortConstants.merchantExtraReschedule}' />
