...
class PaymentCancelInDebtScreen extends BaseScreenWidget {
  static const routeName = '/payment-cancel-indebt-screen';

  const PaymentCancelInDebtScreen({Key? key}) : super(key: key);

  @override
  BaseState<PaymentCancelInDebtScreen> screenCreateState() =>
      _PaymentCancelInDebtScreen();
}

class _PaymentCancelInDebtScreen
    extends BaseScreenState<PaymentCancelInDebtScreen> {
