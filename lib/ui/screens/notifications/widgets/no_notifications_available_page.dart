...
class NoNotificationsAvailablePage extends BaseStatelessWidget {
  NoNotificationsAvailablePage({Key? key}) : super(key: key);
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          width: width * 0.7,
          child: Text(
            translate(LangKeys.noNotificationsAvailable),
