...
class RescheduleDetailsPaymentScreen extends BaseScreenWidget {
  static const routeName = '/reschedule-Details-payment-screen';

  const RescheduleDetailsPaymentScreen({Key? key}) : super(key: key);

  @override
  BaseState screenCreateState() => _RescheduleDetailsPaymentScreenState();
}

class _RescheduleDetailsPaymentScreenState
    extends BaseScreenState<RescheduleDetailsPaymentScreen> {
