...
/// data : {"original_fees_amount":100.0,"new_fees_amount":100.0,"discount_amount":0.0,"discount_percentage":0.0,"currency":"EGP","insurance_id":null,"insurance_name":null,"is_out_side_range":false,"flat_rate":false,"flat_rate_max_fee":null}
/// error_code : 0
/// error_msg : ""
/// error_details : ""
...
class InsuranceDeal {
  ...
  InsuranceDeal.fromJson(dynamic json) {
  ...
  int? totalSeconds;
InsuranceDeal copyWith({  Data? data,
  int? errorCode,
  String? errorMsg,
  String? errorDetails,
  Expiration? expiration,
  Persistence? persistence,
  int? totalSeconds,
}) => InsuranceDeal(  data: data ?? this.data,
