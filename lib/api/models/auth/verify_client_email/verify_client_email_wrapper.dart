import 'package:o7therapy/api/models/auth/verify_client_email/verify_client_email_data.dart';

class VerifyClientEmailWrapper {
  VerifyClientEmailWrapper({
    required this.data,
  ...
  /// data is the user id
  final VerifyClientEmailData? data;
  final int? errorCode;
  ...
  factory VerifyClientEmailWrapper.fromJson(Map<String, dynamic> json) =>
      VerifyClientEmailWrapper(
        data : json['data'] != null ? VerifyClientEmailData.fromJson(json['data']) : null,
