...
class CheckVerifiedEmailWrapper {
  CheckVerifiedEmailWrapper({
    required this.data,
  ...
  final CheckVerifiedEmailData? data;
  final int? errorCode;
  ...
  factory CheckVerifiedEmailWrapper.fromJson(Map<String, dynamic> json) =>
      CheckVerifiedEmailWrapper(
        data : json['data'] != null ? CheckVerifiedEmailData.fromJson(json['data']) : null,
