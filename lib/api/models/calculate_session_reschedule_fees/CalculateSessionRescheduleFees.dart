...
/// data : {"fees_amount":0.0,"fees_percentage":0.0,"currency":"EGP","flat_rate":false}
/// error_code : 0
/// error_msg : ""
/// error_details : ""
...
class CalculateSessionRescheduleFees {
  CalculateSessionRescheduleFees({
      this.data, 
      this.errorCode, 
      this.errorMsg, 
      this.errorDetails, 
  ...
  CalculateSessionRescheduleFees.fromJson(dynamic json) {
  ...
  int? totalSeconds;
CalculateSessionRescheduleFees copyWith({  Data? data,
  int? errorCode,
  String? errorMsg,
  String? errorDetails,
  Expiration? expiration,
  Persistence? persistence,
  int? totalSeconds,
}) => CalculateSessionRescheduleFees(  data: data ?? this.data,
