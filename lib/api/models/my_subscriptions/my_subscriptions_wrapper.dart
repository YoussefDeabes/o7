...
class MySubscriptionsWrapper {
  ...
  final MySubscriptionsInfo? data;
  final int? errorCode;
  ...
  factory MySubscriptionsWrapper.fromJson(Map<String, dynamic> json) =>
      MySubscriptionsWrapper(
        data: json["data"] != null
            ? MySubscriptionsInfo.fromJson(json["data"])
            : null,
...
class MySubscriptionsInfo {
  MySubscriptionsInfo(
  );


  factory MySubscriptionsInfo.fromJson(Map<String, dynamic> json) =>
      MySubscriptionsInfo(
      );
