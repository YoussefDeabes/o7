...
class AccumulativeSessionFees {
  AccumulativeSessionFees({
      this.data, 
      this.errorCode, 
      this.errorMsg, 
      this.errorDetails, 
  ...
  AccumulativeSessionFees.fromJson(dynamic json) {
  ...
  int? totalSeconds;
AccumulativeSessionFees copyWith({  Data? data,
  int? errorCode,
  String? errorMsg,
  String? errorDetails,
  Expiration? expiration,
  Persistence? persistence,
  int? totalSeconds,
}) => AccumulativeSessionFees(  data: data ?? this.data,
